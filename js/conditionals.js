...
var findBill = prompt("Please enter your total bill amount.");
var luckresults = calculateTotal(luckyNumber, findBill);
alert("Hello, your lucky number was "+ luckyNumber +". Your price pre-discount was $"+findBill+". Your bill now " +
    "comes to $"+luckresults+". Thank you for shopping with us!");
